...
export const tutorials: Readonly<Record<GameMode, TutorialDefinition>> = {
  ...
  GO_NO_GO: {
    audioLanguage: TUTORIAL_AUDIO_LANGUAGE,
    instruction: 'Dengarkan suara giliran, lalu genggam hanya saat gambar Wayang muncul.',
    steps: [
      {
        title: 'Dengarkan giliran',
        instruction: 'Permainan dimulai setelah suara giliran Anda selesai.',
        visual: 'Layar menunggu sebentar sebelum gambar pertama muncul.',
        caption: 'Suara hanya diputar sekali di awal permainan.',
      ...
      {
        title: 'Dua tingkat kecepatan',
        instruction: 'Level 1 menampilkan lima gambar selama tiga detik. Level 2 menampilkan lima gambar selama dua detik.',
        visual: 'Pergantian gambar menjadi lebih cepat pada Level 2.',
        caption: 'Tetap fokus saat kecepatannya meningkat.',
      ...
      },
      {
        ...
        caption: 'Permainan selesai setelah sepuluh gambar.',

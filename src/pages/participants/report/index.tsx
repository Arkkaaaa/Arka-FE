...
export function ParticipantReportPage() {
  ...
  if (!participant.data.aggregateSummary || participant.data.aggregateSummary.source !== 'AI') return <main className="report-state">Ringkasan laporan sedang disiapkan.</main>;
